      <div>
         ...
         <div class="container bg_tekstappsvg">
         ...
         <div ng-repeat="report in reports">
              <svg width="575px" height="44px" viewBox="0 0 575 44" version="1.1" >
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
                  <rect id="head" stroke="#979797" fill="#4A4A4A" x="3" y="2" width="40" height="40" rx="8"></rect>
                  <rect id="box" stroke="#979797" fill="#D8D8D8" x="48" y="2" width="500" height="40" rx="8"></rect>
                  ...
                  <rect ng-repeat="key in report.mutations" fill="#4990E2" x="{{(key/report.length * 500) + 50}}px" y="-2" width="5" height="46"></rect>
                </g>
              </svg>
